...
$$\displaystyle f(t) = \frac{1}{2{\rm π}}\int_{-\infty}^{\infty}F(omega){\rm e}^{j\omega t}{\rm d}\omega$$
$$\textstyle f(t) = \frac{1}{2{\rm π}}\int_{-\infty}^{\infty}F(omega){\rm e}^{j\omega t}{\rm d}\omega$$
